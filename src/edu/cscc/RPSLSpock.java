...
/**
 * @author Yogesh Acharya
 */
public class RPSLSpock {

    /**
     * Naming Random rand, and assigning input.
     */
    ...
    /**
     * Tells if an input ia vali, and if not it will return false
     * @param pick
     * @return
     */
    ...
    /**
     * Code to randomly Generate different pick
     * @return
     */
    ...
    /**
     *Telling the Computer to randomly pick a variable.
     * @param c_pick
     * @param h_pick
     * @return
     */
